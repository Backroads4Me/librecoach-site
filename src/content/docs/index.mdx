...
## RV Control, Monitoring, and Automation

<CardGrid>
  <Card title="Control Your RV's Systems" icon="i-mdi:remote" bordered>
    Control lights, shades, locks, pumps, and other RV systems from a single interface. Everything runs locally, with no internet or cloud required.
  </Card>

<Card title="Automatically Detects Your Devices" icon="i-mdi:magnify-scan" bordered>
  LibreCoach finds devices on your RV-C network and brings them into Home
  Assistant. You just give them names you recognize.
</Card>
...
<CardGrid>
  <Card title="DIY Build" icon="i-mdi:hammer-wrench" bordered>
    Build your own LibreCoach system from standard parts with step-by-step guides and photos. If you can follow instructions carefully, you can build it.
