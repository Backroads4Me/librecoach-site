...
**HACS (Home Assistant Community Store)** is a custom integration that gives you access to thousands of community-created integrations, themes, and frontend cards that aren't included in the core Home Assistant installation.

While Home Assistant provides official integrations for major devices, HACS allows the community to fill the gaps, often providing support for new devices, niche hardware, or experimental features long before they make it into the official release.
