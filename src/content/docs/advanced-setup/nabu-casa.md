...
**Home Assistant Cloud** is the official cloud service from the Home Assistant provided by their partner **Nabu Casa**. It provides easy remote access, backups and voice assistant integration while supporting the continued development of Home Assistant.
